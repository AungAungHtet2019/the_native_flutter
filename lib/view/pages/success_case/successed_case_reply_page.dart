...
class SuccessedCaseReplyListPage extends StatefulWidget {
  String userID;
  String caseId;
  String caseTitle;
  List<CaseReplied> caseReplied;
  SuccessedCaseReplyListPage(this.userID,this.caseId,this.caseTitle,this.caseReplied);

  @override
  State<SuccessedCaseReplyListPage> createState() => _SuccessedCaseReplyListPageState();
}

class _SuccessedCaseReplyListPageState extends State<SuccessedCaseReplyListPage> {
  ...
  //       _submit(value);
  //       Provider.of<ReportHistoryProvider>(context,listen: false).getReportHistory(widget.userID);
  //     }
  //     else{
              ...
              children: <Widget>[
                Column(
                  children: <Widget>[
                    ...
                    Expanded(
                        child:ListView(
                          children: widget.caseReplied.map((e) {
                            return Padding(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Column(
                                                children: [
                                                  ...
                                                  ListTile(
                                                    title: Text(e.CreatedDate.split("T")[0]),
                                                    subtitle: Text(e.RepliedBody),
                                                  ),
