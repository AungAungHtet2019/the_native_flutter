...
class _ReportHistoryPageState extends State<ReportHistoryPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Provider.of<ReportHistoryProvider>(context,listen: true).ReportHistoryModel.length == 0  && Provider.of<ReportHistoryProvider>(context,listen: true).DataReturnStatus == false ? ListView.builder(
